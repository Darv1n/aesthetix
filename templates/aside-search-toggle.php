...
<button <?php button_classes( 'search-toggle popup-button icon icon_magnifying-glass', $args ); ?> data-mfp-src="#aside-search" aria-label="<?php esc_attr_e( 'Open Search Form', 'aesthetix' ) ?>" aria-haspopup="true" aria-controls="aside-search">
