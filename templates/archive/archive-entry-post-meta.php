...
<ul class="post-meta" aria-label="<?php esc_attr_e( 'Post meta information', 'aesthetix' ); ?>">
	...
	<?php if ( is_array( $args['post_meta_structure'] ) && ! empty( $args['post_meta_structure'] ) ) {
		foreach ( $args['post_meta_structure'] as $key => $value ) {
			switch ( $value ) {
				case has_action( 'aesthetix_archive_entry_post_meta_loop_' . $value ):
					...
					break;
				case 'author': ?>
					<li class="post-meta-item icon icon-before icon-user">
					...
					<?php break;
				case 'date': ?>
					<li class="post-meta-item icon icon-before icon-calendar">
				...
				case 'category': ?>
					<?php if ( has_category() ) { ?>
						<li class="post-meta-item icon icon-before icon-folder">
				...
				case 'post_tag': ?>
					<?php if ( has_tag() ) { ?>
						<li class="post-meta-item icon icon-before icon-tag">
					...
					<?php break;
				case 'time': ?>
					<li class="post-meta-item icon icon-before icon-clock data-title" data-title="<?php esc_attr_e( 'Reading time', 'aesthetix' ); ?>">
						<?php echo read_time_estimate( get_the_content() ) . ' ' . esc_html__( 'min.', 'aesthetix' ); ?>
					</li>
					<?php break;
				case 'comments': ?>
					<li class="post-meta-item icon icon-before icon-comment">
				...
				case 'edit': ?>
					<?php if ( is_user_logged_in() && current_user_can( 'edit_posts' ) ) { ?>
						<li class="post-meta-item icon icon-before icon-pen-to-square">
