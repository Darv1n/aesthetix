...
<ul class="post-meta" aria-label="<?php _e( 'Post meta information', 'aesthetix' ); ?>">
	...
	<?php if ( get_aesthetix_options( 'archive_' . get_post_type() . '_meta_author_display' ) === true ) { ?>
	...
	<?php if ( get_aesthetix_options( 'archive_' . get_post_type() . '_meta_date_display' ) === true ) { ?>
	...
	<?php if ( get_post_type() === 'post' ) { ?>
		<?php if ( get_aesthetix_options( 'archive_' . get_post_type() . '_meta_cats_display' ) === true && has_category() ) { ?>
		...
		<?php } ?>
		<?php if ( get_aesthetix_options( 'archive_' . get_post_type() . '_meta_tags_display' ) === true && has_tag() ) { ?>
	...
	<?php if ( get_aesthetix_options( 'archive_' . get_post_type() . '_meta_time_display' ) === true ) { ?>
	...
	<?php if ( get_aesthetix_options( 'archive_' . get_post_type() . '_meta_comments_display' ) === true ) { ?>
	...
	<?php if ( is_user_logged_in() && current_user_can( 'edit_posts' ) && get_aesthetix_options( 'archive_' . get_post_type() . '_meta_edit_display' ) === true ) { ?>
