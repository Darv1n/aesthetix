...
<button <?php icon_classes( 'search-toggle popup-button icon icon-magnifying-glass', $args ); ?> data-mfp-src="#aside-search" aria-label="<?php esc_attr_e( 'Popup search button', 'aesthetix' ) ?>" aria-haspopup="true" aria-controls="aside-search" type="button">
