...
<button <?php button_classes( 'subscribe-toggle popup-button icon icon-paper-plane', $args ); ?> data-mfp-src="#aside-subscribe" aria-label="<?php esc_attr_e( 'Popup subscribe button', 'aesthetix' ) ?>" aria-haspopup="true" aria-controls="aside-subscribe" type="button">
