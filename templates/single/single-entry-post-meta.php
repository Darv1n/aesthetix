...
<ul class="post-meta" aria-label="<?php _e( 'Post meta information', 'aesthetix' ); ?>">
	...
	<?php if ( get_aesthetix_options( 'single_' . get_post_type() . '_meta_author_display' ) === true ) { ?>
	...
	<?php if ( get_aesthetix_options( 'single_' . get_post_type() . '_meta_date_display' ) === true ) { ?>
		<li class="post-meta__item icon icon_before icon_calendar">
			<time class="post-date post-date-published data-title" datetime="<?php echo get_the_date( 'Y-m-d\TH:i:sP' ); ?>" data-title="<?php _e( 'Publication date', 'aesthetix' ); ?>"><?php echo get_the_date( 'j F, Y' ); ?></time>
			<?php if ( get_aesthetix_options( 'single_' . get_post_type() . '_meta_date_modified_display' ) && get_the_modified_date( 'j M, Y' ) !== get_the_date( 'j M, Y' ) ) { ?>
				<time class="post-date post-date-modified data-title" datetime="<?php the_modified_date( 'Y-m-d\TH:i:sP' ); ?>" data-title="<?php _e( 'Modification date', 'aesthetix' ); ?>">(<?php the_modified_date( 'j F, Y' ); ?>)</time>
			<?php } ?>
		</li>
	<?php } ?>

	<?php if ( get_post_type() === 'post' ) { ?>
		<?php if ( get_aesthetix_options( 'single_' . get_post_type() . '_meta_cats_display' ) === true && has_category() ) { ?>
		...
		<?php } ?>
		<?php if ( get_aesthetix_options( 'single_' . get_post_type() . '_meta_tags_display' ) === true && has_tag() ) { ?>
	...
	<?php if ( get_aesthetix_options( 'single_' . get_post_type() . '_meta_time_display' ) === true ) { ?>
	...
	<?php if ( get_aesthetix_options( 'single_' . get_post_type() . '_meta_comments_display' ) === true ) { ?>
	...
	<?php if ( is_user_logged_in() && current_user_can( 'edit_posts' ) && get_aesthetix_options( 'single_' . get_post_type() . '_meta_edit_display' ) === true ) { ?>
