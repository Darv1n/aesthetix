...
add_action( 'aesthetix_after_single_entry_post_meta', 'kama_postviews_post_meta_list', 5 );
add_action( 'aesthetix_after_archive_entry_post_meta', 'kama_postviews_post_meta_list', 5 );
