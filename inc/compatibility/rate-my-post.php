...
add_filter( 'get_aesthetix_post_meta_list', 'add_rmp_result_post_meta_list', 80 );
...
add_action( 'aesthetix_after_single_content_part', 'add_rmp_shortcode_after_article_post', 20 );
