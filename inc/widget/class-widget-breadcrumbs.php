...
class WPA_Widget_Breadcrumbs extends WPA_Widget {
	...
	public function __construct() {
		...
		$this->widget_cssclass    = 'widget-breadcrumbs';
		$this->widget_description = __( 'The global settings for this form can be found in the Customizer', 'aesthetix' );
		$this->widget_id          = 'aesthetix-widget-breadcrumbs';
		$this->widget_name        = get_widget_name( 'WPA_Widget_Breadcrumbs' );
		$this->settings           = array(
			'title'            => array(
				'type'  => 'text',
				'std'   => '',
	...
	public function widget( $args, $instance ) {
		...
		get_template_part( 'templates/widget/widget-breadcrumbs', '', $template_args );
